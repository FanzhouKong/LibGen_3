...
def search_spectrum(msms, mz_left, mz_right=None):
    if mz_right is None:
        mz_center = mz_left
        mz_left = mz_center-0.005
        mz_right = mz_center+0.005
    """
    ...
    idx_left, idx_right = mass.searchsorted([mz_left, mz_right+1E-9])
